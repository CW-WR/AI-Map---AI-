...
from app.routers import (
    ...
    admin_nav as admin_nav_router,
    admin_submission as admin_submission_router
)
...
def register_routers(app):
    ...
    app.include_router(admin_nav_router.router)
    app.include_router(admin_submission_router.router)